 /*
    * DDL(Data Defininton Language) : 데이터 정의어
    - 오라클에서 제공하는 객체/스키마를 만들고(CREATE), 변경(ALTER), 삭제(DROP)하는 언어
...
-- USER_TABELS : 사용자가 가지고 있는 테이블들의 전반적인 구조를 확인할 수 있는 시스템 테이블
...
MEM_NO NUMBER PRIMARY KEY,
   ...
   --, FOREIGN KEY(GRADE_ID) REFERENCE MEM_GRADE(GRADE_CODE) --> 테이블레벨방식
);
INSERT INTO MEM VALUES (1, 'user01', 'pass01', '홍길순', '여', null, null, null);
INSERT INTO MEM VALUES (2, 'user02', 'pass02', '김말똥', null, null, null, 10);
INSERT INTO MEM VALUES (3, 'user03', 'pass03', '강개순', '남', null, null, 40);
...
CREATE TABLE TB_BOOK(
   ...
   BK_PRICE NUMBER,
   BK_PUB_NO NUMBER,
   CONSTARINT TB_BOOK_BK_NO_PK PRIMARY KEY(BK_NO),
...
CREATE TABLE TB_MEMBER(
   ...
   CONSTRAINT TB_RENT_NO_PK PRIMARY KEY(RENT_NO),
