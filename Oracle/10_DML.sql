...
-- 표현법 3)
-- EMPLOYEE 테이블에서 직원의 사번, 이름, 부서명, 입사일을 조회해서 EMP_01 테이블 INSERT
...
/*
   ...
   [표현법]
   UPDATE 테이블명
   SET 컬럼명 = 변경하려는값 or (서브 쿼리), 컬럼명 = 변경하려는값 or (서브 쿼리), ... 
   [WHERE 조건];
